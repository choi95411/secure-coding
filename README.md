...
성공한 CI 실행의 `e2e-evidence` 아티팩트에 다음 실제 화면이 저장됩니다.

- `01-product.png`: 상품 등록·상세
- `02-chat.png`: 두 사용자의 1대1 실시간 채팅
- `03-wallet.png`: 송금 후 잔액과 거래 내역
- `04-moderation.png`: 신고 확인과 관리자 제재
